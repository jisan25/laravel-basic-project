                        ...
                        <nav class="menu__nav">
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="menu-item-has-children {{ $routeName == 'home.portfolio' ? 'active' : ''  }}"><a href="{{route('home.portfolio')}}">Portfolio</a>
                                      
                                    </li>
                                    <li class="menu-item-has-children {{ $routeName == 'home.blog' ? 'active' : ''  }}"><a href="{{route('home.blog')}}">Our Blog</a>
                                        
                                    </li>
                                    <li class="{{ $routeName == 'contact.me' ? 'active' : ''  }}"><a href="{{ route('contact.me') }}">contact me</a></li>
                                </ul>
                            </div>
