                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="blog_category_id" class="form-select" aria-label="Default select example">
                                    ...
                                    <option value="{{$category->id}}" {{ $category->id == $data->blog_category_id ? 'selected' : '' }}>{{$category->category_name}}</option>                                        
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="blog_title" type="text" placeholder="Enter blog_title" id="blog_title" value="{{ $data->blog_title; }}">
                                @error('blog_title')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                               <textarea id="elm1" name="blog_description" >{{ $data->blog_description; }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" class="rounded avatar-lg" src="{{ url($data->blog_image) }}" alt="">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="blog_tags" type="text" placeholder="Enter blog_tags" id="blog_tags" value="{{ $data->blog_tags; }}" data-role="tagsinput">
                                @error('blog_tags')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
