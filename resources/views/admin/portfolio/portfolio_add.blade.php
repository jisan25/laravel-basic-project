                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="portfolio_name" type="text" placeholder="Enter Name" id="portfolio_name">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="portfolio_title" type="text" placeholder="Enter portfolio_title" id="portfolio_title" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($data->portfolio_image)) ? url($data->portfolio_image):url('upload/no_image.jpg') }}" alt="">
                            </div>
                        </div>
